...
class FL_Proc:
    def __init__(self, configs):
        ...
        # log_name
        self.logName = "fedCeaClip_" + "_"+str(self.PClients) + "_" + self.DataName + "_" + self.ModelName + "_" + str(self.Alpha)        
        self.updateIDs = []
        ...
        log_folder = os.path.join("./log_diffMith/fedceaClip", self.logName)
    ...
    def main(self):
        ...
        for c in range(self.NClients):
            ...
            if self.ALA:
                ...
                self.Clients[c] = Client_clip_Sim(self.ClientLoaders[c], self.GModel, self.LR, self.WDecay, self.Epoch,self.FixLR, self.Optmzer,self.Depochs)
