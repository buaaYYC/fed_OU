...
if __name__ == '__main__':
    ...
    parser.add_argument("-dname", type=str,default="cifar100", help="Description of param2")
    parser.add_argument("-mname", type=str,default="resnet", help="Description of param2")
