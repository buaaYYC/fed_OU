...
class FL_Proc:
    def __init__(self, configs):
        ...
        # log_name
        self.logName = "fedCEA_"+str(self.PClients) + "_" + self.DataName + "_" + self.ModelName + "_" + str(self.Alpha)        
        self.updateIDs = []
        ...
        log_folder = os.path.join("./log_diffMith/fedCEA", self.logName)
    ...
    def get_train_datas(self):
        ...
        for batch_id, (inputs, targets) in enumerate(self.ClientLoaders):
        ...
        for It in range(self.MaxIter):
           ...
           # 如果不用CriticalFL方法更新，而是用随机更新，则是执行下面的程序
            ...
            for ky in updateIDs:
                ...
                # print(f"self.ClientLoaders[ky]:{len(self.ClientLoaders)},ky:{ky}")
